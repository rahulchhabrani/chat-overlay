(function () {
  ...
  function connectKick(channel) {
    ...
    // Fetch chatroom ID via background (needs host_permissions for kick.com)
  ...
  function renderMessage(username, color, text, twitchBadges, platform, isSuperchat, skipSave) {
    ...
    // Username: Twitch color if set, else white. Message: white.
  ...
  function updateHeader() {
    ...
    statusEl.innerHTML = parts.map(p => {
      // p looks like "🟣rahulgambit" or "🟢slug" or "🔴YT"
